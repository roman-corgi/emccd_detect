...
for i in range(npts):
    ...
    bright_frame = emccd_detect(fluxmap, frametime, em_gain, full_well_image,
                                ...
                                bias, qe, cr_rate, pixel_pitch, True)
    # Photon-count
    bright_pc = copy.copy(zero_frame)
...
pp1 = poisson.pmf(1, r_phe)
pp2 = poisson.pmf(2, r_phe)
pp3 = poisson.pmf(3, r_phe)
